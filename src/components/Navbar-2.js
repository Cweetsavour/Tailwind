...
const Navbar2 = () => {
  ...
  return (
    <nav className="sticky flex justify-start items-center gap-10 shadow-sm pl-20 top-0 left-0 w-full z-10 bg-white/80 text-sky-900 px-4 py-3">
      <img
      ...
      >
        ...
        {open && (
          ...
          "
          >
            <p className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Item 1</p>
            <p className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Item 2</p>
            <p className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Item 3</p>
            <p className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Item 4</p>
          </div>
        )}
      </div>
      <p
